...
AllConfigs = {}
AllConfigs['bitfit_t5-base'] = collections.OrderedDict({
                                "delta_type": "bitfit",
                                ...
                                "model_name_or_path": "../../../../plm_cache/t5-base",
                                "tokenizer_name": "../../../../plm_cache/t5-base",
                                "save_total_limit": 1,
                                # For glue datasets.
...
AllConfigs['adapter_t5-base'] = collections.OrderedDict({
                                "delta_type": "adapter",
                                ("job_name", "task_name", "eval_dataset_name", "test_dataset_name", "num_train_epochs", 
                                "max_source_length",
                                "per_device_train_batch_size", "per_device_eval_batch_size", "warmup_steps","save_steps", "eval_steps"): zip(
...
AllConfigs['lora_t5-base'] = collections.OrderedDict({
                                "delta_type": "lora",
                                ("job_name", "task_name", "eval_dataset_name", "test_dataset_name", "num_train_epochs", 
                                "max_source_length",
                                "per_device_train_batch_size", "per_device_eval_batch_size", "warmup_steps","save_steps", "eval_steps"): zip(
...
AllConfigs['compacter_t5-base'] = collections.OrderedDict({
...
AllConfigs['compacter++_t5-base'] = collections.OrderedDict({
                                "delta_type": "compacter",
                                ("job_name", "task_name", "eval_dataset_name", "test_dataset_name", "num_train_epochs", 
                                "max_source_length",
                                "per_device_train_batch_size", "per_device_eval_batch_size", "warmup_steps","save_steps", "eval_steps"): zip(
...
AllConfigs['low_rank_adapter_t5-base'] = collections.OrderedDict({
