...
from opendelta.delta_models.adapter1_t5 import AdapterModel
...
parser.add_argument("--data_dir", type=str, default="/home/hushengding/huggingface_datasets/saved_to_disk/") # sometimes, huggingface datasets can not be automatically downloaded due to network issue, please refer to 0_basic.py line 15 for solutions. 
