...
plm = plm.cuda()
mydeltamodel = LoraModel(modify_module_list = ["attn.q","attn.v"], lora_r=args.lora_r,lora_alpha=args.lora_alpha, lora_dropout=args.lora_dropout, mapping=Mappings[args.model])
