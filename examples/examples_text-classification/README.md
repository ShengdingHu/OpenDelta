...
This repository contains the examples that uses OpenDelta to do text-classification in a traditional classification mode, i.e., with a classification head on top of the language model. Almost all of the training pipeline codes remain the same, except for three minimum changes.


1. Arguments of delta models are incorporated in Line 48 and Line 195
2. Insertion of delta models after the original model is load in Line 344 to Line 345

To enable only save the delta parameters, additional line need to be inserted.
TODO

# Below are the origininal Huggingface Examples
